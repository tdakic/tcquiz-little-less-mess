...
$url = htmlspecialchars_decode(new moodle_url('/mod/quiz/accessrule/tcquiz/wait_for_students.php',['joincode'=>$joincode, 'sessionid' => $sessionid,  'attemptid' => $attemptid, 'cmid' => $cmid, 'quizid' => $quizid ]));
$PAGE->set_url($url);
